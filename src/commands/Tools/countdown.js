...
export default {
    data: new SlashCommandBuilder()
        .setName("countdown")
        .setDescription("Lance un compte à rebours")
        .addIntegerOption((option) =>
            option
                .setName("minutes")
                .setDescription("Nombre de minutes (0-1440)")
                .setMinValue(0)
                .setMaxValue(1440)
                .setRequired(false),
        )
        .addIntegerOption((option) =>
            option
                .setName("seconds")
                .setDescription("Nombre de secondes (0-59)")
                .setMinValue(0)
                .setMaxValue(59)
                .setRequired(false),
        )
        .addStringOption((option) =>
            option
                .setName("title")
                .setDescription("Titre optionnel pour le compte à rebours")
                .setRequired(false),
        ),
    ...
    async execute(interaction) {
        ...
        try {
            ...
            await InteractionHelper.safeEditReply(interaction, {
                content: "✅ Compte à rebours lancé !",
