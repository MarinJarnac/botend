...
export default {
    data: new SlashCommandBuilder()
        .setName('report')
        .setDescription('Signaler un utilisateur aux modérateurs ou configurer le salon des signalements.')
        ...
        .addSubcommand(subcommand =>
            subcommand
                .setName('setchannel')
                .setDescription('Définir le salon où les signalements sont envoyés. (Requis : Gérer le serveur)')
